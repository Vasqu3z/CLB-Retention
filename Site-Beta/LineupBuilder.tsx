...
const AVAILABLE_PLAYERS: Player[] = [
  ...
  { id: "2", name: "Luigi", team: "Fireballs", teamColor: "#2ECC71", position: "2B/SS", stats: { avg: ".305", power: 70, speed: 80, chemistry: ["Mario", "Daisy"] } },
  { id: "3", name: "Bowser", team: "Monsters", teamColor: "#F4D03F", position: "1B/C", stats: { avg: ".280", power: 95, speed: 45, chemistry: ["Bowser Jr", "Wario"] } },
  { id: "4", name: "Peach", team: "Monarchs", teamColor: "#FF69B4", position: "CF/RF", stats: { avg: ".350", power: 60, speed: 85, chemistry: ["Mario", "Daisy"] } },
  { id: "5", name: "Yoshi", team: "Eggs", teamColor: "#2E86DE", position: "CF/LF", stats: { avg: ".295", power: 65, speed: 90, chemistry: ["Birdo"] } },
  { id: "6", name: "Donkey Kong", team: "Wilds", teamColor: "#8D6E63", position: "1B/LF", stats: { avg: ".265", power: 98, speed: 55, chemistry: ["Diddy Kong"] } },
  { id: "7", name: "Wario", team: "Muscles", teamColor: "#F1C40F", position: "3B/C", stats: { avg: ".240", power: 90, speed: 50, chemistry: ["Waluigi", "Bowser"] } },
  { id: "8", name: "Waluigi", team: "Spitballs", teamColor: "#9B59B6", position: "P/SS", stats: { avg: ".230", power: 75, speed: 70, chemistry: ["Wario"] } },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-xs font-mono text-white/40">{AVAILABLE_PLAYERS.length} players</div>
            </div>
            ...
            <div className="sticky top-24">
              <div className="mb-4">
                ...
                {selectedPlayer && (
                  ...
                  >
                    <AlertCircle size={16} />
                    Click a valid position for {selectedPlayer.name} ({selectedPlayer.position})
                  </motion.div>
                )}
              </div>
              ...
              <div className="relative w-full aspect-square max-w-2xl mx-auto perspective-1000">
                ...
                {Object.entries(POSITIONS).map(([pos, coords]) => {
                  ...
                  const isValidForSelected = selectedPlayer?.position.includes(pos);
                ...
                <svg className="absolute inset-0 pointer-events-none" style={{ zIndex: 5 }}>
                  {Object.entries(roster).map(([pos1, player1]) => {
                    ...
                    return Object.entries(roster).map(([pos2, player2]) => {
                      ...
                      const hasChemistry = player1.stats.chemistry.includes(player2.name);
                      if (!hasChemistry) return null;
