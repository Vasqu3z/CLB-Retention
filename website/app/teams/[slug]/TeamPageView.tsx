          ...
          <table className="w-full font-mono text-sm">
            ...
            <tbody>
              {sortedHitters.map((player, idx) => (
                <tr key={player.name} className="border-b border-star-gray/10 hover:bg-space-black/20 transition-colors">
...
function SortableHeader({
  ...
  return (
    <th
      className="px-4 py-3 text-left text-sm font-display font-semibold text-star-white cursor-pointer hover:bg-space-black/40 transition"
...
function TeamGameRow({ game, teamName }: { game: ScheduleGame | PlayoffGame; teamName: string }) {
  ...
  const content = (
    <div className="px-6 py-4 hover:bg-space-black/20 transition-colors">
