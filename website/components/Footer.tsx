...
export default function Footer() {
  ...
  const links = [
    { name: "Standings", href: "/standings", color: "comets-cyan" },
    { name: "Schedule", href: "/schedule", color: "comets-red" },
    { name: "Teams", href: "/teams", color: "comets-purple" },
    { name: "Players", href: "/players", color: "comets-yellow" },
  ];
